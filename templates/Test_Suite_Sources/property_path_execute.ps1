...
$template_file = "$template_dir\property_path_template.xml"
$source_file = "$source_dir\property_path_source.xml"
$base_dir = ".\output"
$source_strategy = "TextMetal.Framework.Source.Primative.WellKnownXmlPersistEngineSourceStrategy, TextMetal.Framework"
$strict = $true
